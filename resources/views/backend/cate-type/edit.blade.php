...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{{ route('cate-type.index') }}">Danh mục cha</a></li>
  ...
  <section class="content">
    <a class="btn btn-default btn-sm" href="{{ route('cate-type.index') }}" style="margin-bottom:5px">Quay lại</a>
    ...
    <div class="row">
      ...
      <div class="col-md-7">
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          <form role="form" method="POST" action="{{ route('cate-type.update') }}">
            {!! csrf_field() !!}
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                <label>Tên loại danh mục <span class="red-star">*</span></label>
                <input type="text" class="form-control" name="name" id="name" value="{{ $detail->name }}">
              </div>
              <div class="form-group">
                <label>Slug <span class="red-star">*</span></label>
                <input type="text" class="form-control" name="slug" id="slug" readonly="readonly" value="{{ $detail->slug }}">
              </div>
            ...
            <div class="box-footer">
              ...
              <a class="btn btn-default btn-sm" class="btn btn-primary btn-sm" href="{{ route('cate-type.index')}}">Hủy</a>
            </div>
