...
<div class="content-wrapper">
  ...
  <section class="content">
    <a class="btn btn-default btn-sm " href="{{ route('bao-gia.index', ['type' => $type]) }}" style="margin-bottom:5px">Quay lại</a>
    <form role="form" method="POST" action="{{ route('bao-gia.store') }}">
    <div class="row">
      <!-- left column -->
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->               
              ...
              @endif
                <div class="form-group">
                  ...
                  <select class="form-control" name="type" id="type">                                
                    <option value="1" {{ 1 ==  old('type', $type) ? "selected" : "" }}>Thiết kế kiến trúc</option>
                    <option value="2" {{ 2 ==  old('type', $type) ? "selected" : "" }}>Thi công xây dựng</option>                    
                  </select>
                </div>              
                 <!-- text input -->
                <div class="form-group">
            ...
            <div class="box-footer">
              ...
              <a class="btn btn-default btn-sm" class="btn btn-primary btn-sm" href="{{ route('bao-gia.index', ['type' => $type ]) }}">Hủy</a>
            </div>
