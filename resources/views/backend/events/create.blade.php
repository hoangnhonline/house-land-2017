            ...
            <div class="box-body">
              ...
              @endif              
                ...
                <div class="form-group" style="margin-top:10px;margin-bottom:10px">  
                  ...
                  <div class="col-md-9">
                    <img id="thumbnail_small" src="{{ old('banner_small') ? Helper::showImage(old('banner_small')) : URL::asset('public/admin/dist/img/img.png') }}" class="img-thumbnail" width="80" >
                ...
                <div class="form-group" style="margin-top:10px;margin-bottom:10px">  
                  ...
                  <div class="col-md-9">
                    <img id="thumbnail_large" src="{{ old('large_banner') ? Helper::showImage(old('large_banner')) : URL::asset('public/admin/dist/img/img.png') }}" class="img-thumbnail" width="200" >
