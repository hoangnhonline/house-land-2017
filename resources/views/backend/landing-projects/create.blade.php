            ...
            <div class="box-body">
              ...
              @endif                     
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" rows="3" name="address" id="address">{{ old('address') }}</textarea>
                </div>
                <div class="form-group">
                  <label>Địa chỉ liên hệ</label>
                  <textarea class="form-control" rows="3" name="address_contact" id="address_contact">{{ old('address_contact') }}</textarea>
                </div>  
                <div class="form-group">                  
                  <label>Điện thoại</label>                  
                  <input type="text" class="form-control" name="phone_contact" id="phone_contact" value="{{ old('phone_contact') }}">
                </div>  
                <div class="form-group">                  
                  <label>Email</label>                  
                  <input type="text" class="form-control" name="email_contact" id="email_contact" value="{{ old('email_contact') }}">
                </div>             
            </div>          
